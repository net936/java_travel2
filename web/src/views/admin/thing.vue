            ...
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="营业时间">
                  <a-input placeholder="请输入" v-model:value="modal.form.yyTime" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="余票数" name="repertory">
              ...
              <a-col span="12">
                <a-form-item label="等级">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.level">
                    ...
                    <a-select-option value="2A级">2A级</a-select-option>
                    <a-select-option value="3A级">3A级</a-select-option>
                    <a-select-option value="4A级">4A级</a-select-option>
                    <a-select-option value="5A级">5A级</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
              <a-col span="12">
...
<script setup>
  ...
  const modal = reactive({
    ...
    rules: {
      ...
      repertory: [{ required: true, message: '请输入', trigger: 'change' }],
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        if (modal.form.yyTime) {
          formData.append('yyTime', modal.form.yyTime);
        }
        if (modal.form.repertory) {
